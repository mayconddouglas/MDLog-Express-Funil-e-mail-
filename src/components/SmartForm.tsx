...
import { ArrowRight, CheckCircle2, Loader2, Sparkles, Building, MapPin, Phone, Mail, User, Truck, ShieldCheck, FileText } from 'lucide-react';
        ...
        {currentStep === 0 && (
          ...
          >
            <div className="mb-4 flex items-center justify-center">
              <FileText className="w-8 h-8 text-neutral-200 stroke-[1.5]" />
            </div>
            ...
            <p className="text-neutral-400 text-xs sm:text-sm mb-5 max-w-md font-normal">
            ...
            <button
              ...
              type="button"
              className="group py-2.5 px-6 text-xs sm:text-sm font-semibold rounded-[5px] bg-white text-black hover:bg-[#EAEAEA] transition-all flex items-center space-x-2 shadow-lg cursor-pointer"
            >
              <span>Começar</span>
